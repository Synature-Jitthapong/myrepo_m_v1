...
import com.synature.foodcourtdemo.datasource.model.CashInOutOrderDetail;
import com.synature.foodcourtdemo.datasource.model.Comment;
...
public abstract class PrinterBase {
	...
	protected void createTextForPrintSummaryReport(int sessionId, int staffId, String dateTo){
		...
		mTextToPrint.append(mContext.getString(R.string.shop) + " " + mShop.getShopProperty().getShopName() + "\n");
		if(sessionId != 0){
			com.synature.foodcourtdemo.datasource.model.Session sess = session.getSession(sessionId);
