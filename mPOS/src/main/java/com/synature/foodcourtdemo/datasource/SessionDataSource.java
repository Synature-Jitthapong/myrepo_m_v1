...
public class SessionDataSource extends MPOSDatabase{
	 ...
	 */
	public List<com.synature.foodcourtdemo.datasource.model.Session> listSession(String sessDate){
		List<com.synature.foodcourtdemo.datasource.model.Session> sl =
				new ArrayList<com.synature.foodcourtdemo.datasource.model.Session>();
	 ...
	 * @return com.synature.mpos.database.model.Session
	 */
	public com.synature.foodcourtdemo.datasource.model.Session getSession(int sId){
		com.synature.foodcourtdemo.datasource.model.Session s =
				new com.synature.foodcourtdemo.datasource.model.Session();
	...
	private com.synature.foodcourtdemo.datasource.model.Session toSession(Cursor cursor){
		com.synature.foodcourtdemo.datasource.model.Session s
			= new com.synature.foodcourtdemo.datasource.model.Session();
		s.setSessionId(cursor.getInt(cursor.getColumnIndex(SessionTable.COLUMN_SESS_ID)));
		s.setSessionDate(cursor.getString(cursor.getColumnIndex(SessionTable.COLUMN_SESS_DATE)));
